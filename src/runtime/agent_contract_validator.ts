export class AgentContractValidator {
private static contracts: Record<string, string[]> = {
...
static validate(agentId: string, payload: any): boolean {
const contract = this.contracts[agentId];
if (!contract) return true;

if (!payload) return false;

return contract.every(field =>
