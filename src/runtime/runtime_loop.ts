...
private resourceSampler: any = { sample: () => ({ timestamp: Date.now(), cpuPercent: 0, memoryPercent: 0, memoryUsedMb: 0, systemLoad: 0 }) },
) {}
...
const dispatchMap: Record<string, any> = {
  ...
  await new Promise(resolve =>
    setTimeout(resolve, this.tickRate)
  );
}
